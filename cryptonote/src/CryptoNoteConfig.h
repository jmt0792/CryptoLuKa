...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x135d7f; // addresses start with "jmt"
...
const char     CRYPTONOTE_NAME[]                             = "jmt";
...
const CheckpointData CHECKPOINTS[] = {
	{ 9000, "3e7b089856003ff9706e8db0a530bfec03d91143491086a2835fcdc2a38373e0"}
 };
}
